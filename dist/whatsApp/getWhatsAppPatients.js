...
exports.getWhatsAppPatients = void 0;
const postgres_1 = require("../config/postgres");
const logging_1 = __importDefault(require("../config/logging"));
const bcrypt_1 = __importDefault(require("bcrypt"));
const dotenv_1 = require("dotenv");
const NAMESPACE = 'API';
const getWhatsAppPatients = async (req, res) => {
...
exports.getWhatsAppPatients = getWhatsAppPatients;
//# sourceMappingURL=getWhatsAppPatients.js.map