...
const NAMESPACE = 'API';
async function putMarked(req, res, next) {
    ...
    (0, postgres_1.Connect)()
        ...
        logging_1.default.info(NAMESPACE, 'Update schedule result: ', result);
    }).then(() => {
...
exports.putMarked = putMarked;
;
//# sourceMappingURL=putMarked.js.map