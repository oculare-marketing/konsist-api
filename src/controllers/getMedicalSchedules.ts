...
export const getMedicalSchedules = async (req: Request, res: Response, next: NextFunction) => {
  logging.info(NAMESPACE, 'Result Medical schedules:');
...
.then( async data =>{
      ...
      logging.info(NAMESPACE, 'Result Medical schedules: ', result);
      
      const results = result.sort(function (x: any, y: any){
